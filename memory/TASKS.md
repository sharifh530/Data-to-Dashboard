...
| B01 | PARTIAL | Dedicated dtd-sandbox WSL2 + gVisor installed; eight real isolation probes and writable-root negative control passed. Resource/termination/adversarial tests remain. docs/evidence/2026-09-17-wsl-sandbox.md. |
